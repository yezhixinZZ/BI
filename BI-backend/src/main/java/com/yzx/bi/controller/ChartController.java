...
import com.yzx.bi.bizmq.BiMessageProducer;
...
import com.yzx.bi.manager.RedisLimiterManager;
import com.yzx.bi.model.dto.chart.*;
import com.yzx.bi.model.entity.Chart;
import com.yzx.bi.model.entity.User;
import com.yzx.bi.model.vo.BiResponse;
import com.yzx.bi.service.ChartService;
import com.yzx.bi.service.UserService;
import com.yzx.bi.utils.ExcelUtils;
import com.yzx.bi.utils.SqlUtils;
...
public class ChartController {
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<Chart>> listChartByPageAdmin(@RequestBody ChartQueryRequest chartQueryRequest) {
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        //ai模型id （鱼聪明ai）
        long modelId = 1822559746923159554L;
        //用户输入
